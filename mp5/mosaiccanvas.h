 ...
 * @file mosaiccanvas.h
 *
 * Definition of a mosiac data structure.
 *
...
/**
 * MosaicCanvas class: This is the actual mosaic data-structure which will
 * hold the matrix of sub-images to be written.  This is effectively just a
 * 2-D array of TileImage objects which can be accessed via convenience
 * methods.
 *
 * @author Matt Sachtler
 * @author Scott Wegner
