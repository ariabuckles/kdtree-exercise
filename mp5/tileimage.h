...
/**
 * TileImage class: represent candidate images to replace regions in the
 * mosaic.
 *
 * @author Aria Buckles
 * @date Fall 2011
...
class TileImage
{
	...
	/**
	 * Finds the average color of the TileImage.
	 *
	 * @return The average color of this TileImage.
	 */
